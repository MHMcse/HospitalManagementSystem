                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview <?php echo $billing;?>">
                            <a href="#">
                                <i class="fa fa-credit-card"></i> <span>Costing Check</span>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php if($hasAccesstoSurgical){?><li <?php echo $surgical_costing?>><a href="<?php echo base_url()?>app/surgical_costing"><i class="fa fa-angle-double-right"></i>Surgical Costing</a></li><?php }?>
                            </ul>
                        </li>
                        <?php }?>
                        ...
                        <li class="treeview <?php echo $patient;?>">
                            <a href="#">
                                <i class="fa fa fa-wheelchair"></i> <span>Nurse Management</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                ...
                                <?php if($hasAccesstoPatient){?><li <?php echo $patient_master_mode;?>><a href="<?php echo base_url()?>app/patient/index"><i class="fa fa-angle-double-right"></i>Patient List</a></li><?php }?>
                                <?php if($hasAccesstoOPDRegistration == TRUE && $hasAccesstoOPDEnquiry == TRUE){?>
                                
								<li class="treeview <?php echo $opd;?>">
                                    <a href="#">
                                    <i class="fa fa-angle-double-right"></i><span>Out Patient Department</span>
                                    <i class="fa fa-angle-left pull-right"></i>
                                    </a>
                                    <ul class="treeview-menu">
                                ...
                                <li class="treeview <?php echo $ipd;?>">
                                    <a href="#">
                                    <i class="fa fa-angle-double-right"></i><span>In Patient Department</span>
                                    <i class="fa fa-angle-left pull-right"></i>
                                    </a>
                                    <ul class="treeview-menu">
                        ...
                        <li class="treeview <?php echo $room_m;?>">
                            <a href="#">
                                <i class="fa fa-hospital-o"></i> <span> Ward Management</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                ...
                                <?php if($hasAccesstoRooms){?><li <?php echo $sub_room_master_mod;?>><a href="<?php echo base_url()?>app/room_master">&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-double-right"></i>Room Details</a></li><?php }?>
                                <?php if($hasAccesstoRooms){?><li <?php echo $sub_room_bed_mod;?>><a href="<?php echo base_url()?>app/room_bed">&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-double-right"></i>Room Bed Details</a></li><?php }?>
                            </ul>
                        </li>
                        <?php }?>
                        ...
                        <li class="treeview <?php echo $nurse_module;?>">
						   ...
						   <a href="#">
                                <i class="fa fa-plus-square"></i> <span> Nurse Management</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                ...
                                <?php if($hasAccesstoNurseInOutTake){?><li <?php echo $nurse_intake_output;?>><a href="<?php echo base_url()?>app/nurse_module/intake_output">&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-double-right"></i>In/Out Record</a></li><?php }?>
                        ...
                        <li class="treeview <?php echo $emr;?>">
                            <a href="#">
                                <i class="fa fa-book"></i> <span> Patient Report Sheet</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <?php if($hasAccesstoEMROPD){?><li <?php echo $opd_emr;?>><a href="<?php echo base_url()?>app/emr/opd"><i class="fa fa-angle-double-right"></i>Out-Patient Report</a></li> <?php }?>
                        ...
                        <li class="treeview <?php echo $user_mgnmt;?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php if($hasAccesstoUsers){?><li <?php echo $user_index;?>><a href="<?php echo base_url()?>app/user"><i class="fa fa-angle-double-right"></i>System User list</a></li> <?php }?>
                       ...
                       <li class="treeview <?php echo $admin;?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php if($hasAccesstoAdminDesignation){?><li <?php echo $designation_mod;?>><a href="<?php echo base_url()?>app/designation"><i class="fa fa-angle-double-right"></i>Designation List</a></li>  <?php }?> 
                                ...
                                <!-- <?php if($hasAccesstoAdminComplain){?><li <?php echo $complain_mod;?>><a href="<?php echo base_url()?>app/complain"><i class="fa fa-angle-double-right"></i>Complain List</a></li><?php }?> -->
                                <!-- <?php if($hasAccesstoAdminDiagnosis){?><li <?php echo $diagnosis_mod;?>><a href="<?php echo base_url()?>app/diagnosis"><i class="fa fa-angle-double-right"></i>Diagnosis List</a></li><?php }?> -->
                        ...
                        <li class="treeview <?php echo $reports;?>">
                            ...
                            <ul class="treeview-menu">
                                <?php if($hasAccesstoReportPatient){?><li <?php echo $patient_list_report_mod;?>><a href="<?php echo base_url()?>app/reports/patient_list"><i class="fa fa-angle-double-right"></i>Patient list Generate Report</a></li><?php }?>
