                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane" id="tab_2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="86%">
                                                        <?php echo form_input('noofhouse',set_value('noofhouse'),'id="noofhouse" class="form-control input-sm" placeholder="Present Address" style="width: 250px;"');?>
                                                        <?php echo form_hidden('brgy',set_value('brgy'),'id="brgy" class="form-control input-sm" placeholder="Brgy./Subd." style="width: 250px;"');?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    	<td width="14%">Parmanent Address</td>
                                                        <td width="86%">
                                                        <?php echo form_input('address2',set_value('address2'),'id="address2" class="form-control input-sm" placeholder="Parmanent Address" style="width: 250px;"');?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    	<td width="14%">City</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="86%">
                                                        <?php echo form_input('phone_office',set_value('phone_office'),'id="phone_office" class="form-control input-sm" placeholder="Phone No" style="width: 250px;"');?>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="86%">
                                                        <?php echo form_input('phone',set_value('phone'),'id="phone" class="form-control input-sm" placeholder="TelePhone No" style="width: 250px;"');?>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="86%"> 
                                                        <?php echo form_input('mobile',set_value('mobile'),'id="mobile" class="form-control input-sm" placeholder="Fax No" style="width: 250px;"');?>
                                                        </td>
                                                    </tr>
