                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane" id="tab_2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="86%">
                                                        <?php echo form_input('noofhouse',set_value('noofhouse'),'id="noofhouse" class="form-control input-sm" placeholder="House No" style="width: 250px;"');?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    	<td width="14%">Area</td>
                                                        <td width="86%"> 
                                                        <?php echo form_input('brgy',set_value('brgy'),'id="brgy" class="form-control input-sm" placeholder="Area" style="width: 250px;"');?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    	<td width="14%">City</td>
