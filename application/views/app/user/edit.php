                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="general_information">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="86%">
                                                        <?php echo form_input('noofhouse',set_value('noofhouse',$user->street),'id="noofhouse" class="form-control input-sm" placeholder="House No" style="width: 250px;"');?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="14%">Area</td>
                                                        <td width="86%"> 
                                                        <?php echo form_input('brgy',set_value('brgy',$user->subd_brgy),'id="brgy" class="form-control input-sm" placeholder="Area" style="width: 250px;"');?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="14%">City</td>
                                                        <td width="86%"> 
                                                        <?php echo form_input('province',set_value('province',$user->province),'id="province" class="form-control input-sm" placeholder="City" style="width: 250px;"');?>
                                                        </td>
                                                    </tr>
                                                    <tr>
